...
Класс с тестами на класс `Rational`, которые покрывают операции с числами.
...
- Тест (void setNumeratorTest())  проверяет работу сеттера числителя.

- Тест (void setDenominatorTest()) проверяет работу сеттера знаменателя.
